class Devise::RegistrationsController < DeviseController
  ...
  def create
    ...
    if resource.save
      ...
      set_error_message(email_error, password_error)
  ...
  def set_error_message(email_error, password_error)
    ...
    elsif password_error && password_error.first == "doesn't match confirmation"
      flash[:error] = "Las contrase&ntilde;as no coinciden."
    end
  end  
